...
void CForge::Initialize()
{
    ...
    m_pFrameKey = L"Ani_SI_I_1";
    m_tFrame = { 0, 2, 0, 150, (DWORD)GetTickCount64() };

    Change_Ground();

    CSoundMgr::Get_Instance()->StopSound(SOUND_EFFECT);
    CSoundMgr::Get_Instance()->PlaySound(L"Craft_Forge.wav", SOUND_EFFECT, 0.7f);
...
void CForge::Change_Ground()
{
    ...
    dynamic_cast<CTile*>(CManager::Tile()->Get_VecTile()[iIndex + TILEX])->Set_Option(3);
